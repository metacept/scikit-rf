...
#%% apply it to a dut
dut_raw = measurement
dut_raw.name = '3d_printed_waveguide2!8mm_holes_with_extended_waveguide'
...
# save results
folder = Path('/Users/Zaber/Documents/data/scikit_measurements/NASA/electroplated_waveguide/')
folder.mkdir(exist_ok = True)
dut_corrected.write_touchstone(dut_corrected.name, str(folder))
#%%
fig, ax = plt.subplots()
